...
class KubernetesClient(object):
    ...
    def start_sysdig_capture_for(self, cloud_provider, pod_name, event_time,
                                 duration_in_seconds, bucket,
                                 access=None, secret_key=None):
        ...
        if cloud_provider == "s3":
            body = self._build_sysdig_capture_job_body_s3(job_name,
                                                          node_name,
                                                          duration_in_seconds,
                                                          bucket,
                                                          access,
            ...
            body = self._build_sysdig_capture_job_body_gcloud(job_name,
                                                              node_name,
                                                              duration_in_seconds,
                                                              bucket)
    ...
    def _build_sysdig_capture_job_body_gcloud(self, job_name, node_name,
                                              duration_in_seconds, gcloud_bucket):
        return client.V1Job(
            metadata=client.V1ObjectMeta(
                name=job_name
            ),
    ...
    def _build_sysdig_capture_job_body_s3(self, job_name, node_name,
